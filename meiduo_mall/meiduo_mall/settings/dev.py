...
SECRET_KEY = '-8s&e+)m_uap%zcp*zn3(tac$86(a74f1+eul)$%j(ai+zrkqw'
...
# 1, Jinja2配置:   https://yiyibooks.cn/xx/Django_1.11.6/topics/templates.html
TEMPLATES = [
    {
...
# 2, mysql数据库配置: 	https://yiyibooks.cn/xx/Django_1.11.6/ref/settings.html#std:setting-DATABASES
DATABASES = {
    'default': {
...
# 3, redis配置:  https://django-redis-chs.readthedocs.io/zh_CN/latest/
CACHES = {
    "default": {
...
# 4, 日志配置:  https://yiyibooks.cn/xx/Django_1.11.6/topics/logging.html
LOGGING = {
    'version': 1,
